...
| --- | --- | --- | --- | --- | --- | --- |
| `apwStyle` | `apw-style` | `any` | no | no | _none_ | `8` |
| `customTreeNodeRenderer` | _none_ | `unknown` | no | no | _none_ | `16` |
| `data` | _none_ | `unknown` | no | no | `dataChanged` | `16` |
