...
| --- | --- | --- | --- | --- | --- | --- |
| `apwDisabled` | `apw-disabled` | `boolean` | yes | yes | `disabeldChanged` | `1540` |
| `apwRequired` | `apw-required` | `boolean` | yes | no | _none_ | `516` |
| `apwStyle` | _none_ | `unknown` | no | no | _none_ | `16` |
| `apwTabindex` | `apw-tabindex` | `number` | yes | no | _none_ | `514` |
| `checked` | _none_ | `boolean` | yes | yes | `checkedChanged` | `1540` |
| `inputId` | `input-id` | `string` | yes | yes | _none_ | `1537` |
| `labelPosition` | `label-position` | `string` | yes | no | _none_ | `513` |
| `value` | _none_ | `string` | yes | yes | _none_ | `1537` |
