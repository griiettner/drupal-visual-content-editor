...
- Chunk file: `p-4759b943.js`
- Component flags: `1`
- Properties: 7
- Internal state fields: 0
- Public methods: 0
- Event listeners: 0
...
| --- | --- | --- | --- | --- | --- | --- |
| `activeIndex` | `active-index` | `number` | yes | yes | _none_ | `1538` |
| `apwReadonly` | `apw-readonly` | `boolean` | no | no | _none_ | `4` |
| `apwStyle` | _none_ | `unknown` | no | no | _none_ | `16` |
| `orientation` | _none_ | `string` | no | no | _none_ | `1` |
| `space` | _none_ | `number` | no | no | _none_ | `2` |
| `steps` | _none_ | `unknown` | no | no | _none_ | `16` |
| `tooltipProps` | _none_ | `unknown` | no | no | _none_ | `16` |
